...
const App = () => {
  ...
  return (
    <div className="p-3 flex justify-center items-center w-full">
      <div className="w-full xl:w-1/2 self-center border-4 p-5 rounded-xl border-solid border-blue-500 flex flex-col gap-y-10 md:gap-y-20">
        ...
        <div className='flex flex-col gap-y-3'>
          ...
          <form className="w-full flex flex-col border-solid border-blue-500 border-4 rounded-xl p-3 gap-y-5" onSubmit={handleSubmit}>
            <div className="w-full flex flex-col gap-y-3">
              ...
              <input type="text" id="activity" name="activity" className="border-2 border-solid border-blue-500 p-2 md:p-3 rounded-xl bg-blue-500 text-white text-lg md:text-xl" />
            </div>
            <div className="w-full flex flex-col md:flex-row gap-y-3 md:gap-x-8">
              <div className="w-full flex flex-col gap-y-3">
                <label htmlFor="time-start" className="font-semibold text-lg md:text-3xl">Start Time :</label>
                <input type="time" id="time-start" name="time-start" className="border-2 border-solid border-blue-500 p-2 md:p-3 rounded-xl bg-blue-500 text-white text-lg md:text-xl" />
              </div>
              <div className="w-full flex flex-col gap-y-3">
                <label htmlFor="time-end" className="font-semibold text-lg md:text-3xl">End Time :</label>
                <input type="time" id="time-end" name="time-end" className="border-2 border-solid border-blue-500 p-2 md:p-3 rounded-xl bg-blue-500 text-white text-lg md:text-xl" />
              </div>
            </div>
            <div className="flex flex-col gap-y-3">
        ...
        <section className='flex flex-col gap-y-3'>
          <div className='flex justify-between items-center'>
            ...
            <button className='bg-blue-500 px-3 md:py-1 rounded-full text-white font-semibold text-lg md:text-2xl' onClick={handleClear}>Clear</button>
          </div>
          <div className='w-full flex flex-col border-solid border-blue-500 border-4 rounded-xl p-3 gap-y-5'>
            {showTodo ? (
              <div className='w-full flex flex-col gap-y-3 md:grid md:grid-cols-2 md:gap-5'>
